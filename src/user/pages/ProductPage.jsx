...
import ProductPageLoader from "../components/loader/ProductLoader/ProductPageLoader";
      ...
      {product?.loading ? (
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-4 lg:px-6">
            <div className="flex items-baseline justify-between border-b border-gray-200 p-6">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3 md:col-span-2 w-full">
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 bg-white py-5">
                    {product?.products?.pageContent ? (
